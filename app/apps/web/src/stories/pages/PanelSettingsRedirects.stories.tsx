...
const meta = { title: 'Pages/PanelSettingsRedirects', id: 'panel-settings-redirects', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'pl', layout: 'fullscreen' } } satisfies Meta;
export default meta;

...
export const pl: Messages = {
  ...
  auth: {
    ...
    emailHelper: 'W następnym kroku wybierzesz link wysłany e-mailem, hasło albo klucz dostępu.',
    orSeparator: 'albo',
    ...
    noAccessLink: 'Zobacz kursy',
    privacyPolicy: 'Polityka prywatności',
    poweredBy: 'Obsługiwane przez',
    footerCourses: 'Kursy',
    footerCommunity: 'Społeczność',
    cannotSignIn: 'Nie możesz się zalogować? Napisz do nas',

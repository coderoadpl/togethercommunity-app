...
export const en: Messages = {
  ...
  auth: {
    ...
    signInLead: 'Enter the email you used when you bought or joined — we will check how you can sign in.',
    preferences: 'Language and theme',
    emailLabel: 'Email address',
    emailPlaceholder: 'name@example.com',
    emailHelper:
      'We will email you a sign-in link or ask for your password — depending on your account settings.',
    orSeparator: 'or',
    ...
    signInMethodsUnavailable: 'We could not check the available sign-in methods. Try again or pick a sign-in method yourself.',
    signInMethodsRateLimited: 'We could not check the available sign-in methods — try again in a moment.',
    signInMethodsRateLimitedRetryAfter: ({ seconds }) =>
      format('We could not check the available sign-in methods — try again in {seconds} s.', { seconds }),
    ...
    methodLead: 'We found an account for this address. Pick whichever suits you.',
    ...
    magicLinkRequestedBody: ({ email }) =>
      format('We sent a sign-in link to {email}. Open it on this device — no password needed.', { email }),
    magicLinkResend: 'Send the link again',
    magicLinkResendCooldown: ({ seconds }) => format('Send again ({seconds} s)', { seconds }),
    magicLinkResent: 'We sent a new link.',

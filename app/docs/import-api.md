...
- Import scopes cannot be combined with `enrollment`, `marketing`, `transactional`, or `report:read` on the same key. Existing unscoped keys never gain import access.

...
const meta = { title: 'Pages/PanelLessonAttachments', id: 'panel-lesson-attachments', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'pl', layout: 'fullscreen' } } satisfies Meta;
export default meta;

...
const meta = { title: 'Pages/PanelMarketingSendDetail', id: 'panel-marketing-send-detail', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen' } } satisfies Meta;
export default meta;

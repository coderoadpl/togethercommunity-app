...
const meta = { title: 'Pages/PanelMarketingActivityDetail', id: 'panel-marketing-activity-detail', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'pl', layout: 'fullscreen' } } satisfies Meta;
export default meta;

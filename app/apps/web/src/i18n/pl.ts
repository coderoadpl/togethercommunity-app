...
export const pl: Messages = {
  ...
  marketing: {
    ...
    deliveryComplained: 'Zgłoszona jako spam', deliveryOutcomeBounced: 'Ta wysyłka została odbita i nie powinna być traktowana jak dostarczona.',
    deliveryOutcomeComplained: 'Odbiorca zgłosił tę wysyłkę jako spam.',
    ...
    bounceClassification: 'Klasyfikacja odbicia', clickedLink: 'Kliknięty link', eventError: 'Błąd',

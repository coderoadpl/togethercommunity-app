...
const meta = { title: 'Pages/PanelSettingsDomains', id: 'panel-settings-domains', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen' } } satisfies Meta;
export default meta;

...
const POLISH_MAGIC_LINK: MagicLinkLabels = { open: pl.auth.openMagicLink };
...
const captureCommunitySurfaces = async (
  ...
  await page.getByTestId('discussion-composer-input').waitFor({ state: 'visible', timeout: 20000 });

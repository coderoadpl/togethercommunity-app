...
const meta = { title: 'Pages/ResetPasswordInvalid', id: 'reset-password-invalid', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen' } } satisfies Meta;
export default meta;

...
export const pl: Messages = {
  ...
  marketing: {
    ...
    skipReason: 'Powód pominięcia', bounceClassification: 'Klasyfikacja odbicia', eventError: 'Błąd',
    eventTypes: {
      queued: 'dodana do kolejki', claimed: 'pobrana do wysyłki', rendered: 'wyrenderowana', accepted: 'przyjęta',
      delivered: 'dostarczona', bounced: 'odbita', complained: 'zgłoszona jako spam', skipped: 'pominięta',
    ...
    configurationSetLabel: 'configuration set', snsTopicLabel: 'ARN tematu SNS', footer: 'Obowiązkowa stopka', footerLegalNameLabel: 'pełna nazwa prawna',

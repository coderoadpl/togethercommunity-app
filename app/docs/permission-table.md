...
Closed capability count: 115. Route rows: 379. Exported `Ctx` use-case rows: 294.
...
|---|---|---|
| api-key | `apps/server/src/internal-app.ts:12` | `API_KEY_HEADER,` |
| api-key | `apps/server/src/internal-app.ts:176` | `authenticateApiKey,` |
| api-key | `apps/server/src/internal-app.ts:1075` | `const presentedKey = c.req.header(API_KEY_HEADER);` |
| api-key | `apps/server/src/internal-app.ts:1077` | `const authed = await authenticateApiKey(tenant.value.tenant.id, presentedKey, deps);` |
| staff-role | `apps/server/src/internal-app.ts:1594` | `(identity.staffRole \|\| identity.memberId)` |
| member-scope | `apps/server/src/internal-app.ts:1594` | `(identity.staffRole \|\| identity.memberId)` |

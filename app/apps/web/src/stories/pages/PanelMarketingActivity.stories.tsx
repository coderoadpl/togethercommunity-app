...
const meta = { title: 'Pages/PanelMarketingActivity', id: 'panel-marketing-activity', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'pl', layout: 'fullscreen' } } satisfies Meta;
export default meta;

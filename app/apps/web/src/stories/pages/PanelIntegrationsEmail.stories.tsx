...
const meta = { title: 'Pages/PanelIntegrationsEmail', id: 'panel-integrations-email', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen', preloadFonts: false } } satisfies Meta;
export default meta;

...
export const pl: Messages = {
  ...
  messages: {
    ...
    optOutLabel: 'Nie pozwalaj członkom społeczności wysyłać mi wiadomości',
  ...
  events: {
    ...
    deleteConfirmBody: 'Wydarzenie zniknie z przestrzeni i z kalendarza członków. Wątek dyskusji zostanie zachowany.',
    panelEmpty: 'Brak wydarzeń w tej przestrzeni',
    panelEmptyHint: 'Zaplanuj pierwsze wydarzenie — członkowie zobaczą je w przestrzeni i na stronie startowej.',
  ...
  community: {
    ...
    composerPlaceholder: 'Podziel się czymś z przestrzenią…',
    post: 'Opublikuj',
    posting: 'Publikowanie…',
    ...
    backToSpaces: 'Wróć do przestrzeni',
  ...
  spacesPanel: {
    ...
    moderationHeading: 'Moderacja',
    moderationHint:
      'Jako zespół możesz usunąć dowolny wpis bezpośrednio w przestrzeni — otwórz przestrzeń i użyj opcji „Usuń” przy wpisie.',
  ...
  support: {
    ...
    settingsHeading: 'Wsparcie dla uczestników',
    settingsIntro:

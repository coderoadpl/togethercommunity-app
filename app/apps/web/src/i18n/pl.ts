...
export const pl: Messages = {
  ...
  marketing: {
    ...
    deliveryStatusLabel: 'dostarczenie', campaignLabel: 'kampania', recipient: 'Odbiorca', subject: 'Temat',
    ...
    credentials: 'Dane dostępowe SES', credentialsHint: 'Kampanie używają wyłącznie klucza z konta tej przestrzeni.', accessKeyLabel: 'access key ID', secretKeyLabel: 'secret access key',

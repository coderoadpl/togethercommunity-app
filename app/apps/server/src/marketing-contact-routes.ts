  ...
  app.get(API_PATHS.marketingImportsTick, async (c) => {
    ...
    for (const tenantId of await deps.marketingDirectoryJobs.tenantIds()) {
      ...
      const ctx: Ctx = { identity: {
        ...
        tenantAccess: 'member', tenantId, tenantSlug: null, tenantName: null, staffRole: null, memberId: null, memberDisplayName: null, memberBannedAt: null, memberDmOptOutAt: null, memberLanguage: null, memberVideoAutoplay: false,

...
const plan: Scenario[] = [
  ...
  { name: 'panel-marketing-send-detail-auth', principal: 'creator@together.dev', tenant: 'studio', page: 'panel-marketing-send-detail-auth', route: '/panel/marketing/sends/transactional/send-studio-auth-magic-link', courseId: '', lessonId: '', spaceId: '', extra: async (api) => { await api.getEmailSend('transactional', 'send-studio-auth-magic-link'); } },

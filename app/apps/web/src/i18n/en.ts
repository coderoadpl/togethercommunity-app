...
export const en: Messages = {
  ...
  marketing: {
    ...
    credentialsConfigured: 'SES credentials', identityVerified: 'Identity and DKIM', webhookVerified: 'SNS webhook test', footerConfigured: 'Footer details', webhookUrl: 'SES/SNS webhook URL',

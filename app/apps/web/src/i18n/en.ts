...
export const en: Messages = {
  ...
  auth: {
    ...
    emailHelper: 'In the next step you will pick an emailed link, a password or a passkey.',
    orSeparator: 'or',
    ...
    noAccessLink: 'Browse the courses',
    privacyPolicy: 'Privacy policy',
    poweredBy: 'Powered by',
    footerCourses: 'Courses',
    footerCommunity: 'Community',
    cannotSignIn: 'Cannot sign in? Write to us',

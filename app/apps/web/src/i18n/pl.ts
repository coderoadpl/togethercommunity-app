...
export const pl: Messages = {
  ...
  marketing: {
    ...
    reportAudienceTitle: 'Audytorium', reportMessageTitle: 'Wiadomość', expandMessage: 'Pokaż podgląd wiadomości',
    ...
    consentedMembersChip: 'kursanci ze zgodą', campaignRunsTitle: 'Przebiegi tej kampanii', campaignRunsEmpty: 'Żadne uruchomienie harmonogramu nie objęło jeszcze tej kampanii.',

...
export const pl: Messages = {
  ...
  sales: {
    ...
    emptyBody: 'Udostępnij klientom link do zakupu produktu, aby rozpocząć sprzedaż.',
  ...
  checkout: {
    ...
    subscriptionSuccessBody: 'Dostęp zostanie nadany po potwierdzeniu pierwszej płatności przez Stripe. Wyślemy Ci wiadomość z magicznym linkiem.',
    goToLogin: 'Przejdź do logowania',

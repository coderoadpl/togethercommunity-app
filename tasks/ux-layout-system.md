...
- **Storybook + in-house story comparator** (decision point 2/3) — available in
  `app/.storybook/`, `app/scripts/visual-story-screenshots.ts`, and
  `app/tasks/lost-pixel-baselines/`; the separate route harness covers 102

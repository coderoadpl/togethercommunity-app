...
const meta = { title: 'Pages/PanelSettingsDomainsActive', id: 'panel-settings-domains-active', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen', docs: { description: { component: 'The inherited active-named goldens captured cached pending DNS records. Recorded Pending stories preserve those images; Active stories show the verified routing response.' } } } } satisfies Meta;
export default meta;

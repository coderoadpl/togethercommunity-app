  ...
  it('authenticates with an encrypted BYO token, isolates tenant sessions, and refreshes access', async () => {
    ...
    const fetcher: typeof fetch = async (input, init) => {
      ...
      if (url.pathname.endsWith('/sessions/session-ref/invoices/invoice-ref')) {
        ...
        return json({
          ...
          acquisitionDate: '1998-07-27T10:01:00.3403321+00:00',
          invoicingDate: '1998-07-27T12:01:00.1234567+02:00',
          permanentStorageDate: '1998-07-27T10:02:00.0000000+00:00',
    ...
    expect(await client.getInvoiceStatus({
      ...
      value: {
        code: 200,
        ksefNumber: '5555555555-20260727-ABC-01',
        acquisitionAt: '1998-07-27T10:01:00.340Z',
        invoicingAt: '1998-07-27T10:01:00.123Z',
        permanentStorageAt: '1998-07-27T10:02:00.000Z',
      },
    });

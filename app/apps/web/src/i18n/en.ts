...
export const en: Messages = {
  signupForms: {
    noList: 'No list',
    title: "Signup forms",
    description: "Collect newsletter signups on a branded page or your own website.",
    create: "Create form",
    edit: "Edit form",
    empty: "No signup forms yet",
    slug: "Slug",
    consent: "Consent definition",
    chooseConsent: "Choose a consent definition",
    singleOptIn: "Single opt-in",
    doubleOptIn: "Double opt-in",
    list: "Optional list",
    listHelp: "Leave unselected to record contacts without adding them to a list.",
    tags: "Tags separated by |",
    collectName: "Ask for an optional name",
    successEn: "Success message in English",
    successPl: "Success message in Polish",
    defaultSuccessEn: "Thank you for signing up.",
    defaultSuccessPl: "Thank you for signing up.",
    redirect: "Redirect URL (optional)",
    redirectHelp: "HTTPS only. Leave empty to use the hosted thank-you page.",
    origins: "Allowed JSON origins",
    originsHelp: "One exact HTTPS origin per line, without a trailing slash or path.",
    invalid: "Check the required fields, slug, URLs and tag limits.",
    embed: "Embed",
    embedHelp: "Replace a deployed snippet after changing the consent definition. JSON requests from browsers require an allowed origin.",
    hostedLink: "Hosted page link",
    htmlEmbed: "HTML form",
    jsonExample: "JSON example",
    labelLanguage: "Language of the visitor labels",
    email: "Email address",
    displayName: "Name (optional)",
    submit: "Sign up",
    last24h: "Submissions · 24 h",
    last7d: "Submissions · 7 d",
    total: "Total submissions",
    confirmed: "Confirmed / single opt-in",
    pending: "Pending confirmation",
    actions: "Actions",
    editorHelp: "The consent definition determines whether email confirmation is required. Saving refreshes the consent wording, and the embed token changes only when that wording changes.",
    suppressionLifted: "Suppression lifted after signup",
  },
  ...
  common: {
    ...
    free: 'Free',
    priceOneTime: ({ price }) => format('{price} one-off', { price }),
    priceMonthly: ({ price }) => format('{price}/mo.', { price }),
    priceYearly: ({ price }) => format('{price}/yr.', { price }),
    add: 'Add',
    open: 'Open',
    close: 'Close',
    clear: 'Clear',
  ...
  imageAssets: {
    ...
    invalidRasterType: 'Choose a PNG, JPEG, or WebP image.',
    remove: 'Remove',
  ...
  markdownEditor: {
    tabsAria: 'Choose the Markdown editing mode',
    editorTab: 'Editor',
    markdownTab: 'Markdown',
    toolbarAria: 'Text formatting',
    bold: 'Bold',
    boldShort: 'B',
    italic: 'Italic',
    italicShort: 'I',
    ...
    undo: 'Undo',
    redo: 'Redo',
    linkDialogTitle: 'Add or edit a link',
    linkUrlLabel: 'Link URL',
    linkInvalid: 'Enter a full address beginning with https:// or mailto:.',
  ...
  errors: {
    ...
    headingImpersonationReadOnly: 'Member view is read-only',
    ...
    messageImpersonationReadOnly: 'While viewing as a member you cannot change anything or open messages.',
    ...
    messageIntegrationNotConfigured: 'This integration is not configured yet.',
    messageIntegrationAuth: 'The external service rejected the stored key.',
    messageEmailSendingNotConfigured: 'E-mail sending is not configured yet.',
    messagePlatformEmailPoolExhausted: 'The starter sending pool is exhausted.',
    panelHintIntegrationNotConfigured: 'Fill in its details in the Integrations section.',
    panelHintIntegrationAuth: 'Check the key in the Integrations section.',
    panelHintEmailSendingNotConfigured: 'Set the sender and provider in Integrations → E-mail.',
    panelHintPlatformEmailPoolExhausted:
      'Configure your own provider in Integrations → E-mail.',
    panelHintInvoiceExemptionBasisMissing:
      'Open Settings → Company → Automatic invoices and enter the provision you rely on (for example art. 113 ust. 1).',
    ...
    messageInvoiceExemptionBasisMissing: 'VAT exemption is selected but the legal basis is missing. Polish law requires it on the invoice.',
  ...
  signInNoticeSettings: {
    save: 'Save sign-in notice',
    heading: 'Sign-in',
    enabled: 'Show the sign-in notice',
    label: 'Notice text',
    helper: 'Visible to everyone on the sign-in page, for example information about moving from a previous platform.',
    counter: ({ count }) => format('{count} / 600', { count }),
  },
  auth: {
    signInNoticeLabel: 'Sign-in notice',
    invalidCredentials: 'Invalid email or password.',
    signInRateLimited: 'Try again in a moment.',
    signInTitle: 'Sign in',
    signInToTenant: ({ tenant }) => format('Sign in to {tenant}', { tenant }),
    signInLead: 'Enter the email you used when you bought or joined.',
    preferences: 'Language and theme',
    emailLabel: 'Email address',
    emailPlaceholder: 'name@example.com',
    emailHelper:
      'Next, choose a sign-in link by email or use your password.',
    orSeparator: 'or',
    ...
    identifierPending: 'Please wait…',
    signingInAs: ({ email }) => format('Signing in as {email}', { email }),
    changeIdentifier: 'Use a different e-mail',
    changeIdentifierShort: 'Change',
    signInMethodsUnavailable: 'We could not continue. Try again or choose a sign-in method.',
    signInMethodsChoosePrompt: 'Or pick a sign-in method right away:',
    signInMethodsChooseMagicLink: 'Sign in with a link',
    signInMethodsChoosePassword: 'I have a password',
    methodTitle: 'How do you want to sign in?',
    methodLead: 'Choose the sign-in method that suits you.',
    ...
    twoFactorUseBackupCode: 'No access to the app? Use a backup code',
    twoFactorBackToLogin: 'Back to sign-in',
    continueWithGoogle: 'Continue with Google',
    forgotPassword: 'Forgot your password?',
    magicLinkPending: 'Sending the link…',
    magicLinkExpired: 'This link has expired or was already used. Enter your email and request a new one.',
    magicLinkExpiredOnStep: 'The previous link expired. We will send a new one — you can also sign in with a password.',
    checkInboxTitle: 'Check your inbox',
    magicLinkRequestedBody: () => 'If an account exists, we have sent a sign-in link.',
    magicLinkResend: 'Send the link again',
    magicLinkResendCooldown: ({ seconds }) => format('Send again ({seconds} s)', { seconds }),
    magicLinkResent: 'If an account exists, we have sent another sign-in link.',
    magicLinkFetching: 'Fetching dev magic link…',
    openMagicLink: 'Open magic link (development mode)',
    demoAccount: 'Demo account:',
    registerPrompt: 'New here?',
    registerLink: 'Create an account',
    noAccessPrompt: 'No access yet?',
    noAccessLink: ({ tenant }) => format('Browse courses from {tenant}', { tenant }),
  ...
  sections: {
    ...
    marketingForms: "Signup forms",
    marketingLists: 'Lists',
  ...
  panel: {
    ...
    accountMenuUnread: ({ count }) => format('Account menu, unread messages: {count}', { count }),
    memberView: 'Student view',
  ...
  notifications: {
    ...
    emptyHint:
      'We will let you know when someone replies to your post or something new lands in your spaces.',
  ...
  messages: {
    ...
    emptyListHint: 'To message someone, open their post and select “Message author”.',
    ...
    startFromAuthor: 'Send a message',
    starting: 'Opening the conversation…',
    unreadAria: ({ count }) => format('Unread messages: {count}', { count }),
    privacyHeading: 'Privacy',
    optOutLabel: 'Do not let community members send me messages',
    optOutHint: 'The community team can still reach you for support.',
  ...
  events: {
    ...
    urlLabel: 'Meeting link (optional)',
    timeOrderError: 'An event has to end after it starts.',
    deleteEvent: 'Delete event',
    deleteConfirmTitle: 'Delete this event?',
    deleteConfirmBody: 'The event disappears from the space and from member calendars. The discussion thread stays.',
    panelEmpty: 'No events in this space',
    panelEmptyHint: 'Schedule the first event — members will see it in the space and on their start page.',
    liveNow: 'Live now',
    liveBadge: 'Live',
    liveJoin: 'Join',
    liveHeading: 'Live stream',
    liveFrameTitle: 'Live stream player',
    replay: 'Recording',
    replayFrameTitle: 'Recording player',
    liveEmbedUrlLabel: 'Live stream link (optional)',
    liveEmbedUrlHint: 'YouTube, Vimeo or Bunny Stream. The stream shows up on the event page while the event runs.',
    replayUrlLabel: 'Recording link (optional)',
    replayUrlHint: 'The recording shows up once the event is over.',
    embedUrlError: 'Only YouTube, Vimeo and Bunny Stream links are supported.',
  },
  emailVerification: {
  ...
  security: {
    passkeyProofShort: 'Your current password confirms this change.',
    passkeyHelp: 'How passkeys work',
    passkeyDescription: 'Sign in with your device or security key.',
    passkeysUnavailable: 'Passkey status unavailable',
    sessionsUnavailable: 'Status unavailable',
    sessionsSummary: ({ count }) => `Active sessions: ${count}`,
    passkeyCount: ({ count }) => `Passkeys: ${count}`,
    continueSetup: 'Continue',
    disableTwoFactorConfirm: 'Confirm your password to turn off two-factor verification.',
    wizardSteps: { password: '1 of 5 · Confirm your password', qr: '2 of 5 · Scan the QR code', verify: '3 of 5 · Verify the code', codes: '4 of 5 · Save backup codes', done: '5 of 5 · Done' },
    twoFactorStatusUnknown: 'Status unavailable',
    twoFactorStatusIncomplete: 'Setup incomplete',
    twoFactorStatusOn: 'On',
    twoFactorStatusOff: 'Off',
    scanQrCode: 'Scan this QR code with your authenticator app.',
    qrCodeLabel: 'Authenticator setup QR code',
    manualSetup: 'Enter a key manually',
    secretLabel: 'Secret key',
    copyBackupCodes: 'Copy all',
    backupCodesCopied: 'Copied',
    downloadBackupCodes: 'Download .txt',
    backupCodesSaved: 'I saved them',
    finishSetup: 'Finish setup',
    setupComplete: 'Two-factor authentication is ready.',
    twoFactorDescription: 'Add an authenticator code to protect your sign-in.',
    heading: 'Security',
    ...
    passkeyPasswordLabel: 'Current account password',
    ...
    scanOrCopyKey: 'Copy this key into your authenticator',
    ...
    sessionsIntro: 'Devices and browsers signed in to your account. Sign out any you do not recognise.',
    ...
    sessionSignedInAt: ({ date }) => format('Signed in {date}', { date }),
    sessionLastActiveAt: ({ date }) => format('Last active {date}', { date }),
    sessionRevoke: 'Sign out this device',
    sessionRevoking: 'Signing out…',
    sessionRevoked: 'Device signed out.',
    sessionRevokeConfirmTitle: 'Sign out this device?',
    sessionRevokeConfirmBody: 'That device will have to sign in again.',
    sessionsRevokeOthers: 'Sign out all other devices',
    sessionsRevokingOthers: 'Signing out…',
    sessionsOthersRevoked: 'All other sessions were signed out.',
    sessionsRevokeOthersConfirmTitle: 'Sign out the other sessions?',
    sessionsRevokeOthersConfirmBody: 'Other devices will have to sign in again.',
  },
  telemetryStore: {
    "title": "Statistics",
    "intro": "Connect your own MongoDB Atlas database to store campaign engagement and contact activity.",
    "connection": "Connection string",
    "region": "Region label",
    "connect": "Connect store",
    "probe": "Test connection",
    "disconnect": "Disconnect",
    "confirmDisconnect": "Disconnect store and keep existing copies",
    "disconnectWarning": "Disconnecting stops synchronization. Existing copies stay in your database and its backups. You remain responsible for pending deletion requests.",
    "connected": "Connected",
    "disconnected": "Disconnected",
    "probing": "Testing connection…",
    "error": "The connection could not be verified. Check the access list and database credentials.",
    "success": "Connection verified",
    "stable": "Add this address to the Atlas access list:",
    "dynamic": "Outbound addresses change. Allow 0.0.0.0/0 only with TLS and unique credentials scoped to this database, or use a relay with a fixed IP address.",
    "unknown": "A fixed outbound IP address has not been confirmed. Ask your operator for a static address or relay. If you allow 0.0.0.0/0, require TLS and unique credentials scoped to this database.",
    "lastAck": "Last acknowledged sequence",
    "lastSync": "Last synchronization",
    "pending": "Pending buffer",
    "oldest": "Oldest pending event",
    "gaps": "Missing events",
    "never": "Not yet",
    "empty": "Empty",
    "unavailable": "Statistics are unavailable. Connect your own MongoDB Atlas store to enable campaign statistics and contact history.",
    "privacy": "Only selected event identifiers, timestamps, engagement, activity and purchase references are synchronized. Email bodies, IP addresses, location and user agents stay out of this store. Connecting storage does not grant tracking consent.",
    "pause": "The buffer reached its admission threshold, so only bounce, complaint and unsubscribe events are still accepted. Automatic sending pauses are planned for the next release."
},
  integrations: {
    ...
    reportKeysScope: 'Reports (read only)',
    reportKeysHint: 'Reads tenant activity reports. Cannot be combined with write scopes. No expiry; revoke when no longer needed.',
    tabApiKeys: 'API keys',
    ...
    stripeTestDescription: 'Use a Stripe sandbox restricted key (rk_test_). Test purchases are isolated from live sales and do not email members.',
    stripeTestEndpointRegistered: 'Test webhook endpoint registered',
    stripeTestLastEvent: ({ value }) => format('Last test event: {value}', { value }),
    stripeTestNoEvents: 'No test events yet',
    stripeLiveSlotTestKey: 'The live card holds a sandbox key. Move it to the test-mode card and save an rk_live_ key here — checkout stays unavailable until you do.',
    stripeTestMode: 'Test mode',
    stripeLiveMode: 'Live mode',
    stripeRestrictedPermissions:
      'Use rk_live_ in the live card and rk_test_ in the test card. Grant write access to Checkout Sessions, Coupons, Promotion Codes, Subscriptions, and Webhook Endpoints.',
    ...
    importKeysHeading: 'API keys',
    importKeysDescription:
      'Issue read-only report keys or short-lived keys for draft content and member imports. Import access cannot send email, enroll through the legacy API, or publish content.',
    importKeysNameLabel: 'Key name',
    importKeysNamePlaceholder: 'Migration from a previous platform',
    importKeysScopesLabel: 'Key scopes',
    ...
    importKeysCreate: 'Create API key',
    ...
    importKeysSecretLabel: 'Key secret',
    importKeysLoading: 'Loading API keys…',
    importKeysEmpty: 'No API keys have been created.',
    ...
    importKeysRevokeConfirmTitle: 'Revoke this API key?',
  ...
  products: {
    ...
    importedPrice: 'Imported',
    importedPeriod: ({ interval, count }) => count === 1 ? `Every ${interval}` : `Every ${count} ${interval}s`,
    month: 'Month',
    year: 'Year',
    active: 'Active',
    inactive: 'Inactive',
  ...
  courses: {
    ...
    prefixLabel: 'Prefix',
    prefixHint: 'A short marker shown before the module name in the course syllabus.',
    ...
    historyEmptyBody: 'The first version is stored the next time this course is edited or imported.',
    historyHint: 'Open a version to read it and restore it as a new save.',
    historyUnknownAuthor: 'Unknown',
    historyEntry: ({ ordinal, date, author }) =>
      format('Version {ordinal} · {date} · {author}', { ordinal, date, author }),
    historyEntrySchema: ({ version }) => format('schema v{version}', { version }),
    historySubjectCourse: ({ name }) => format('Course: {name}', { name }),
    historySubjectModule: ({ name }) => format('Module: {name}', { name }),
    historyOpenAria: ({ ordinal }) => format('Open version {ordinal}', { ordinal }),
    versionDialogTitle: ({ ordinal }) => format('Version {ordinal}', { ordinal }),
    versionDialogSubtitle: ({ date, author }) => format('{date} · {author}', { date, author }),
    versionLoading: 'Loading version…',
    versionUnchanged: 'This version matches the current state.',
    versionChangedCount: ({ count }) => format('Differences from the current state: {count}', { count }),
    versionColumnStored: 'In this version',
    versionColumnCurrent: 'Now',
    versionEmptyValue: '— empty —',
    versionFlagOn: 'Yes',
    versionFlagOff: 'No',
    ...
    versionRestoreConfirmTitle: 'Restore this version?',
    versionRestoreConfirmBody: ({ ordinal }) =>
      format(
        'Version {ordinal} will be saved as a new change. History is kept — the current state becomes the next version in it.',
        { ordinal },
      ),
    versionRestoreConfirm: 'Restore',
    versionRestoreDone: ({ ordinal }) => format('Version {ordinal} restored.', { ordinal }),
    versionClose: 'Close',
  ...
  members: {
    ...
    impersonateAction: 'View as',
    impersonateConfirmTitle: 'View as member',
    impersonateConfirmBody: ({ name }) => format('You will see the community exactly as {name} sees it.', { name }),
    impersonateConfirmTtl: 'The view is read-only, messages stay hidden, and the session expires after one hour. Every entry is written to the log.',
    impersonateReasonLabel: 'Reason (optional)',
    impersonateConfirm: 'Open the view',
    impersonateStarting: 'Opening the view…',
    auditLogHeading: 'Team activity log',
    auditLogEmpty: 'No recorded activity yet.',
    auditLogKind: {
      impersonation_started: 'Member view started',
      impersonation_ended: 'Member view ended',
      content_version_restored: 'Content version restored',
      redirect_created: 'Redirect added',
      post_purged: 'Post permanently deleted',
    ...
    adoptSubscription: 'Adopt Stripe subscription',
    adoptionHint: 'Link an existing Stripe subscription to this member. The Stripe customer email must match the member email. Billing continues unchanged.',
    subscriptionIdLabel: 'Stripe subscription ID',
    adoptingSubscription: 'Adopting subscription…',
    adoptionRefusals: {
      'email-mismatch': 'The Stripe customer email does not match this member. Verify the customer and member before trying again.',
      status: 'Only an active subscription, or one with an overdue payment, can be adopted.',
      'not-found': 'This subscription does not exist in the Stripe account connected to this community.',
      unsupported: 'This subscription needs a single fixed recurring price and a customer that still exists in Stripe.',
      conflict: 'This Stripe subscription already belongs to another member, product or price.',
      price: 'The selected product has no price that can carry this Stripe subscription.',
    },
    timelineAdoption: ({ product }) => `Adopted Stripe subscription for ${product}`,
    ...
    timelineEventLabels: {
      ...
      'subscription-adopted': 'Subscription adopted',
  ...
  shell: {
    ...
    closeSheet: 'Close',
    impersonationBanner: ({ name }) => format('Viewing as {name}', { name }),
    impersonationRegionLabel: 'Member view',
    impersonationExit: 'Back to the panel',
    impersonationExiting: 'Going back…',
    impersonationReadOnlyHint: 'Read-only view',
    impersonationExpired: 'The member view has expired — go back to the panel and start again.',
  },
  start: {
    title: 'Start',
    ...
    emptyTitle: 'You have no courses or spaces yet',
  ...
  anon: {
    ...
    emptyTitle: 'This community has no public content',
    emptyBody: 'The creator has not opened any space or course to visitors.',
  },
  search: {
    title: 'Search',
    inputLabel: 'Search posts',
    placeholder: 'Search posts…',
    hint: 'Searches posts in spaces and in lesson discussions — the start of a word is enough.',
    stemHint: 'Try a shorter form of the word, e.g. “variab” instead of “variables”.',
  ...
  student: {
    ...
    productWithoutCoursesTitle: 'This product does not grant access to any course yet',
    productWithoutCoursesBody: 'Courses bundled with this product show up here once the creator releases them.',
    ...
    renewalUnavailable: 'Access has expired. Renewal is not available right now.',
  ...
  courseTree: {
    ...
    courseNotInLibrary: 'This course is not in your library. It may have been removed, or your access may have expired.',
    backToMyCourses: 'My courses',
    searchLessons: 'Search lessons',
    filterPlaceholder: 'Filter by lesson name',
    filterHint: 'Searches lesson and module titles — the start of a word is enough.',
    noMatches: 'No lessons match your search.',
    loadingCourse: 'Loading course…',
    courseNotFound: "We can't open this course",
    lessonDuration: ({ minutes }) => format('{minutes} min', { minutes }),
    unlockAccess: 'Unlock access',
    unlockAccessWithPrice: ({ price }) => format('Unlock access — {price}', { price }),
    accessLocked: 'Locked',
  ...
  lesson: {
    ...
    eyebrow: 'Lesson',
    noContentTitle: 'This lesson has no content yet',
    noContent: 'Move on to the next lesson or go back to the course syllabus.',
    videoPlaceholder: 'No recording has been added to this block yet.',
    openPdf: 'Open the PDF in a new tab',
    contentLocked: 'Content locked',
    noAccessYet: "You don't have access to this lesson yet.",
    lockedInProduct: 'This lesson is in',
    ...
    labelSandbox: ({ provider }) => format('Exercise · {provider}', { provider }),
    linksHeading: 'Links',
  ...
  discussion: {
    ...
    emptyReadOnly: 'Nobody has written anything in this discussion yet.',
    ...
    purgeConfirmTitle: 'Delete this post permanently?',
    purgeConfirmBody: 'This cannot be undone. The post and its content will be permanently removed. Replies to a permanently deleted root post are removed with it. Replies below a deleted reply are also removed.',
    moderatorDeletedPost: 'This post was deleted by a moderator.',
    ...
    searchHint: 'Search post content — the start of a word is enough.',
    searching: 'Searching…',
  ...
  community: {
    ...
    staffNoMember: 'This account has staff access here, but no member profile yet.',
    publicReadOnly: 'Public · anyone can read',
    membersOnly: 'For members',
    productGated: 'For buyers',
    productGatedFor: ({ product }) => format('For buyers: {product}', { product }),
    ...
    emptyFeedReadOnly: 'Nobody has posted in this space yet.',
    openThread: 'Open thread',
    reactAria: ({ emoji }) => format('React: {emoji}', { emoji }),
    addReaction: 'Add a reaction',
    postMenu: 'More post options',
    copyLink: 'Copy link',
    copyLinkDone: 'Post link copied.',
  ...
  account: {
    passwordDescription: 'Change your password using your current one.',
    passwordLinkDescription: 'Set or reset your password by email.',
    passwordLinkHelp: 'About password links',
    avatarUploadHint: 'PNG, JPG or WebP, up to 2 MB.',
    verified: 'Verified',
    unverified: 'Not verified',
    languageHeading: 'Language',
    languageDescription: 'Choose the language for the interface and your emails.',
    appearanceHeading: 'Appearance',
    appearanceDescription: 'Choose a light, dark or automatic appearance.',
    menuStudio: 'Studio',
    ...
    avatarHelp: 'About your profile picture',
    avatarHint:
      'Profile picture: upload your own or sign in with Google to import your account picture. Without a picture, we show your initials.',
    avatarUpload: 'Upload picture',
    avatarUploading: 'Uploading…',
    avatarRemove: 'Remove picture',
    avatarTooLarge: 'The profile picture must be no larger than 2 MB.',
    editName: 'Edit name',
    passwordStatusSet: 'Password set',
    passwordStatusUnset: 'No password',
    setPassword: 'Set password',
    passwordHeading: 'Password',
    passwordIntro:
      'Change your password here using your current password. If you do not have a password yet, use the email password link to set one. Magic-link sign-in keeps working.',
  ...
  changePassword: {
    minimumHint: ({ min }) => `At least ${min} characters.`,
    revokeScopeHint: 'Signs out other devices and domains.',
    ...
    credentialAccountMissing:
      'This account does not have a password yet. Use the set / reset password option.',
  },
  forgotPassword: {
  ...
  branding: {
    ...
    logoLabel: 'Logo for light backgrounds',
    logoHint: 'Used on the light theme, in e-mails and in the share preview.',
    logoDarkLabel: 'Logo for dark backgrounds (optional)',
    logoDarkHint: 'Used on the dark theme. With only one file uploaded, the same variant appears on both backgrounds.',
    logoPlaceholder: 'https://example.com/logo.svg',
    accentLabel: 'Dark-scheme accent',
    accentLightLabel: 'Light-scheme accent (optional)',
    accentLightHint: 'Leave empty to derive an accessible light accent:',
    darkPreview: 'Dark scheme',
    lightPreview: 'Light scheme',
  ...
  tenantDomains: {
    ...
    statusError: 'Error',
    recordsHeading: 'DNS records',
    recordsSummary: ({ count }) => format('DNS records ({count}) ✓', { count }),
    ...
    redirectsManage: 'Manage',
  },
  redirects: {
    title: 'Redirects',
    description: 'Paths this workspace answers with a redirect — imported and added by hand.',
    loading: 'Loading redirects…',
    empty: 'No redirects are configured.',
    emptyHint: 'Add the first redirect, or push them through the import API.',
    noMatches: 'No redirect matches this search.',
    search: 'Search paths',
    backToSettings: 'Addresses',
    ...
    deleteConfirmBody: ({ fromPath }) =>
      format('{fromPath} stops redirecting.', { fromPath }),
    deleteConfirmAction: 'Delete redirect',
    deleted: 'The redirect was deleted.',
    addHeading: 'Add a redirect',
    addSource: 'Source path',
    addSourceHint: 'The path the previous site served, for example /courses/javascript.',
    addSourcePreview: ({ path }) => format('Stored as {path}', { path }),
    targetLegend: 'Redirect target',
    targetCourse: 'Course',
    targetLesson: 'Lesson',
    targetPath: 'Path',
    targetCourseLabel: 'Pick a course',
    targetLessonLabel: 'Pick a lesson',
    ...
    coursesEmpty: 'Add a course first.',
    lessonsEmpty: 'This course has no lessons yet.',
  },
  buildInfo: {
  ...
  checkout: {
    ...
    testPurchaseBody: 'This purchase used the Stripe sandbox. No member email was sent.',
    testModeHint: 'This checkout uses your staff account. Use a paid price without a coupon and a Stripe test card.',
    testModeCouponBlocked: 'Coupons and free offers stay in live mode. Turn test mode off to use them.',
    testModeUnavailable: 'This community has no Stripe sandbox key yet. Turn test mode off to pay, or configure the sandbox in Studio.',
    ...
    couponUnavailable: 'This discount code cannot be used.',
    ...
    simulatedPaymentNote: 'This payment will be simulated — no money is taken.',
  ...
  directory: {
    activeConsent: 'Consent granted',
    activeGrant: 'Current access',
    loadCounts: 'Load counts',
    commitContactsOne: 'Import {count} contact',
    commitContactsFew: 'Import {count} contacts',
    commitContactsMany: 'Import {count} contacts',
    commitSuppressionsOne: 'Import {count} suppression',
    commitSuppressionsFew: 'Import {count} suppressions',
    commitSuppressionsMany: 'Import {count} suppressions',

    eventCreated: 'Contact created',
    eventUpdated: 'Contact updated',
    eventArchived: 'Contact archived',
    eventRestored: 'Contact restored',
    eventLinked: 'Account linked',
    eventUnlinked: 'Account unlinked',
    eventMembershipAdded: 'Added to list',
    eventMembershipRemoved: 'Removed from list',

    contactsTitle: 'Contacts',
    contactsDescription: 'Your marketing directory. A contact does not need an account, and list membership does not grant consent.',
    listsTitle: 'Lists',
    listsDescription: 'Organize contacts into static lists or rules evaluated from current data.',
    importTitle: 'Import contacts',
    suppressionImport: 'Import suppressions',
    upload: 'Upload CSV',
    mapping: 'Mapping and preview',
    attestation: 'Authorization',
    result: 'Import result',
    fileHint: 'UTF-8 CSV, up to 3 MiB and 10,000 rows. Comma or semicolon. Import known suppressions first.',
    file: 'CSV file',
    chooseFile: 'Choose CSV file',
    dropFile: 'Drop a CSV file here or choose one from your device.',
    downloadSample: 'Download sample CSV',
    encodingError: 'The file is not valid UTF-8. Save it as UTF-8 and try again.',
    delimiter: 'Delimiter',
    auto: 'Detect automatically',
    comma: 'Comma',
    semicolon: 'Semicolon',
    fileError: 'Choose a valid UTF-8 CSV file up to 3 MiB.',
    parseError: 'CSV could not be parsed. Choose the delimiter explicitly and check quotes, headers and row widths.',
    ignoreColumn: 'Do not import',
    unknownColumns: 'Unmapped columns will not be imported. Pipes separate tags and list keys; literal pipes inside tokens are unsupported.',
    previewHint: 'The preview shows up to 20 rows after normalization. Check the mapped data, errors, and warnings before continuing.',
    importFields: {
      email: 'Email address',
      name: 'Full name',
    ...
    previewStale: 'The settings changed. Validate a new preview before continuing.',
    next: 'Continue',
    back: 'Back',
    contactsOnly: 'Directory only — no consent',
    consentDefinition: 'Consent definition',
    doiHint: 'Consent imports require an active single-opt-in definition. Double-opt-in definitions are unavailable; you can import directory data only.',
    assertionTime: 'When a consent date is missing, the server records the time of this assertion, not a historical opt-in date.',
    legalEnglish: 'The binding attestation below is recorded in English.',
    note: 'Describe the source, how permission was collected, and where supporting evidence is retained (20–2,000 characters).',
    skipInvalid: 'Skip rejected rows and import valid rows',
    rejectInvalid: 'Reject the batch if any rows are invalid',
    commit: 'Import',
    processingHint: 'Processing continues on the server. You can close this page and return using this batch URL.',
    batchId: 'Batch ID',
    ...
    listsToCreate: 'Lists to create',
    created: 'Created contacts',
    updated: 'Updated contacts',
    unchanged: 'Unchanged contacts',
    ...
    consentsPreserved: 'Consents preserved',
    consentBlockedBySuppression: 'Consent withheld: suppression',
    consentBlockedByWithdrawal: 'Consent withheld: withdrawal',
    suppressionsCreated: 'Suppressions created',
    suppressionsExisting: 'Existing suppressions',
    searchLabel: 'Search',
    ...
    evidenceHint: 'The directory exposes lifecycle receipts. Full consent evidence is not available in this view.',
    noHistory: 'No directory events.',
    memberships: 'Static list memberships',
    newList: 'New list',
    key: 'Immutable key',
    kind: 'List kind',
    static: 'Static',
    ...
    rule: 'Rule',
    tagRule: 'Tags',
    productRule: 'Product grants',
    consentRule: 'Active consent',
    match: 'Match tags',
    any: 'Any tag',
    allTags: 'All tags',
    products: 'Products',
    grantState: 'Grant window',
    ever: 'Any grant, including expired',
    grantHint: 'Includes free, manual and imported grants; this is not payment history.',
    contactCount: 'Contacts',
    suppressedCount: 'Suppressed contacts',
    eligibleCount: 'Eligible for selected consent',
    preview: 'Saved rule preview',
    savePreview: 'Save changes to preview the current rule.',
    remove: 'Remove',
    add: 'Add',
    loadMore: 'Load more',
    none: 'No consent',
    ...
    cancelled: 'Cancelled',
    statusGuidance: {
      draft: 'Finish the mapping and validation before starting this import.',
      preview_queued: 'Preview validation is queued and will start automatically.',
      previewing: 'The preview is being validated in the background.',
      ready: 'Start the import when the preview and authorization are complete.',
      queued: 'The import is queued and will start automatically.',
      processing: 'The import is running; this page will refresh while work continues.',
      completed: 'The import finished cleanly with no rejected rows.',
      completed_with_errors: 'The import finished and some rows were rejected.',
      failed: 'The import stopped before completion; retry unfinished rows or cancel it.',
      cancelled: 'The import was cancelled and no further processing will run.',
    },
    retryImport: 'Retry unfinished rows',
    cancelImport: 'Cancel import',
    errorsPurged: 'Rejected row details were purged after retention, so the error CSV is no longer available.',
    reason: 'Reason',
    at: 'Occurred at',
    defaultSource: 'Default source',
    defaultReason: 'Default suppression reason (only when absent)',
    defaultAt: 'Default timestamp in your local time (only when absent)',
    defaultAtUtc: ({ value }) => format('Recorded as {value} (UTC)', { value }),
    previewProgress: ({ validated, total }) => format('Validated {validated} of {total} rows', { validated, total }),
    previewProgressLabel: 'Preview validation progress',
    previewIssuesLimited: ({ count }) => format('Only the first {count} entries are listed; download the error CSV for the full list.', { count }),
    ...
    searchHint: 'Matches display name and email address.',
    tagsHint: 'Separate multiple tags with pipes.',
    listHint: 'Restrict results to one marketing list.',
    consentStateHint: 'Uses the selected consent definition.',
    consentStateDisabledHint: 'Choose a consent definition to filter by state.',
    suppressionHint: 'Shows whether delivery is blocked.',
    memberHint: 'Filters contacts by account link.',
    archiveStateHint: 'Switches between active and archived contacts.',
    consentDefinitionHint: 'Selects which definition supplies consent state.',
    selectConsent: 'Select a definition to see consent state.',
    clearFilters: 'Clear filters',
    emptyDirectoryTitle: 'No contacts yet.',
    emptyDirectoryBody: 'Import a CSV list or add the first contact manually to start building the directory.',
    contactsSectionTitle: 'Directory results',
  },
  marketing: {
    contactProgress: ({ candidates, skipped, queued, unresolved }) => `${candidates} candidates · ${skipped} skipped · ${queued} queued · ${unresolved} unresolved`,
    campaignProgress: ({ candidates, sent, waiting, skipped, failed }) => `${candidates} contacts · sent ${sent} · waiting ${waiting} · skipped ${skipped} · failed ${failed}`,
    contactAudience: "Contact audience",
    frozenAudience: "This audience is frozen. Return to draft to change it and schedule a new snapshot.",
    audienceEstimateHint: "The count is an estimate until scheduling freezes the audience. Empty selection includes nobody.",
    includeLists: "Include lists",
    excludeLists: "Exclude lists",
    listAlreadyExcluded: "This list is already excluded",
    listAlreadyIncluded: "This list is already included",
    listAudienceOverlap: "A list cannot be both included and excluded.",
    includeConsentedMembers: "Include members with active campaign consent",
    excludeProductGrants: "Exclude people granted these products",
    excludeProductGrantsHint: "Includes expired, free, manual and imported grants. This is not limited to paid purchases.",
    previewContacts: "Preview 20 contacts",
    switchToLists: "Switch to list audiences",
    returnToDraft: "Return to draft",
    contactSends: "Send history",
    audienceBreakdown: ({ candidates, excluded, suppressed, withdrawn, pending, noConsent }) => `${candidates} candidates · ${excluded} excluded · ${suppressed} suppressed · ${withdrawn} withdrawn · ${pending} pending confirmation · ${noConsent} without consent`,
    ...
    exportCsv: 'Export CSV', exporting: 'Exporting…', showSendLogDetails: 'Show details columns',
    hideSendLogDetails: 'Hide details columns', runIdFilter: 'Scheduler run ID',
    ...
    authContentRedacted: 'Message content and sign-in credentials are not stored for security.',
    sourceKindLabels: {
      authMagicLink: 'Sign-in link (platform)',
      authPasswordReset: 'Password reset (platform)',
      authEmailVerification: 'Email verification (platform)',
      ...
      spacePost: 'Space post',
      directMessage: 'Direct message',
      spaceEvent: 'Space event',
      subscriptionPaymentFailed: 'Payment failed',
      subscriptionEnded: 'Subscription ended',
      supportMessage: 'Support message',
      memberErasureRequest: 'Data erasure',
      reputationAlert: 'Reputation alert',
      marketingConsentConfirmation: 'Consent confirmation',
      m2mTransactional: 'API transactional message',
      marketingCampaign: 'Marketing campaign',
    },
    deliveryStatusLabel: 'Delivery status', transportLabel: 'Transport', transportTenantSes: 'Tenant SES',
    ...
    deliveryComplained: 'Complained', sendBouncedAlert: ({ date }) => `This send bounced on ${date} and should not be treated as delivered.`,
    sendComplainedAlert: ({ date }) => `This send was reported as spam by the recipient on ${date}.`,
    statusQueued: 'Queued', statusPending: 'Pending', statusSending: 'Sending',
    ...
    rawMeta: 'Provider / queue payload', sesMessageId: 'SES message ID', skipReason: 'Skip reason',
    suppressionReason: 'Suppression reason', bounceTypeLabel: 'Bounce type',
    bounceProviderType: 'Provider bounce type', bounceSubType: 'Bounce subtype',
    diagnosticCode: 'SMTP diagnostic code', clickedLink: 'Clicked link', eventError: 'Error', unknownReason: 'Unknown reason',
    eventTypes: {
    ...
    activity: {
      ...
      lastRun: 'Last run', noLastRun: 'No runs yet', detailTitle: ({ runId }) => `Run ${runId}`,
      ...
      runDetails: ({ startedAt }) => `Details for run started ${startedAt}`,
      idle: 'Idle',
      ...
      viewSends: 'View sends from this run', viewFailedSends: 'View failed sends from this run',
      runNotFoundTitle: 'Run not found', runNotFoundBody: 'This scheduler run was removed or is no longer available.',
      backToRuns: 'Back to send activity',
      campaignsInProgress: 'Campaigns in progress', noCampaignsInProgress: 'No campaigns are currently scheduled, running, or paused.',
      openCampaignReport: 'Open campaign report', showIdleRuns: 'Show idle runs',
      campaignProgress: ({ sent, candidates }) => `${sent} of ${candidates} sent`,
      campaignProgressLabel: ({ name }) => `Sending progress for ${name}`,
      ...
      statuses: { running: 'Running', completed: 'Run finished', failed: 'Failed' },
    },
    ...
    compactOpensUnavailable: 'Opens —',
    compactClicksUnavailable: 'Clicks —',
    listSent: ({ sent, candidates }) => `sent ${sent}/${candidates}`,
    compactResults: ({ delivered, bounced, complained }) => `delivered ${delivered} · bounces ${bounced} · complaints ${complained}`,
    resultsDelivered: 'Delivered', resultsBounced: 'Bounces', resultsComplained: 'Complaints', resultsFailed: 'Failed', resultsWaiting: 'Waiting to send',
    percentageOfSent: ({ percentage }) => `${percentage} of sent`,
    unresolvedAcceptance: ({ count }) => `${count} sends have unresolved provider acceptance and will not be retried automatically.`,
    trackingDisabledCampaignMetrics: 'Open and click tracking is disabled. Campaign engagement metrics are unavailable until tracking is enabled.',
    trackingDisabledCampaignForm: 'Open and click tracking is disabled. Statistics for this campaign will not be collected.',
    trackingSettingsLink: 'Integrations → Email',
    createdTimeValue: ({ date }) => `Created: ${date}`,
    scheduledTimeValue: ({ date }) => `Send time: ${date}`,
    subjectLabel: 'Email subject', bodyLabel: 'Message content', bodyPlaceholder: 'Write the campaign message…', bodyRequired: 'Add the message content before saving.',
    consentScopeLabel: 'Consent scope', productFilterLabel: 'Optional product filter', allProducts: 'All eligible members',
    ...
    reportAudienceTitle: 'Audience', reportMessageTitle: 'Message', expandMessage: 'Show message preview',
    noIncludedLists: 'No included lists', noConsentDefinition: 'No consent definition', noExcludedLists: 'No excluded lists', noExcludedProducts: 'No excluded products',
    consentedMembersChip: 'members with consent', campaignRunsTitle: 'Runs for this campaign', campaignRunsEmpty: 'No scheduler runs have touched this campaign yet.',
    layoutLabel: 'Email layout', noLayout: 'No layout', audiencePreview: 'Recount audience', audiencePreviewFailed: 'Audience preview failed', audienceCount: ({ count }) => `Eligible recipients: ${count}`,
    create: 'Create campaign', creating: 'Creating…', save: 'Save campaign', saving: 'Saving…', schedule: 'Schedule', campaignScheduleFailed: 'Campaign scheduling failed', scheduling: 'Scheduling…', sendAtLabel: 'Send date and time',
    ...
    scheduleCardTitle: { draft: 'Schedule campaign', scheduled: 'Scheduled campaign', running: 'Running campaign', paused: 'Paused campaign', cancelled: 'Cancelled campaign', finished: 'Finished campaign' },
    workerPickupHint: 'Sending starts on the next scheduled run after this time.',
    ...
    documentHostedMode: 'Hosted document', documentUrlLabel: 'Document URL', hostedDocumentLabel: 'Published document',
    noPublishedDocuments: 'Hosted documents are unavailable until one is published.',
    noPublishedDocumentsSelect: 'No published documents',
    createDocumentLink: 'Create document',
    active: 'Active', archived: 'Archived', versions: 'Wording history',
    ...
    markdownLabel: 'Markdown content', documentMarkdownPlaceholder: 'Write the legal document…', documentMarkdownRequired: 'Add the document content before saving.',
    createDocumentAction: 'Create document', saveDocumentAction: 'Save document',
    ...
    identityDkimReady: 'DKIM verified',
    identityDkimPending: 'DKIM pending',
    identityListAccessDenied: ({ action }: { action: string }) => `Together cannot read the identities of this AWS account. Add the ${action} permission to the AWS key so verified domains can be suggested.`,
    identityDetectedDomainHint: ({ domain }: { domain: string }) => `The from address must belong to the ${domain} domain.`,
    ...
    wizardConfigurationSetLabel: 'Configuration set',
    wizardTopicArnLabel: 'SNS topic',
    wizardSubscriptionEndpointLabel: 'Subscription endpoint',
    ...
    identityCheckedAfterSave: 'Checked after the sender is saved',
    ...
    readinessAttentionItems: ({ items }: { items: string }) => `Review these readiness checks: ${items}`,
    readinessComplete: 'All required readiness checks are complete.',
    identityCheckFailedChip: 'Check failed',
    identityCheckRetry: 'Re-check',
    identityCheckDetails: 'Technical details',
    identityVerifiedSince: ({ checkedAt }: { checkedAt: string }) => `Verified since: ${checkedAt}`,
    identityErrorInvalidClientTokenId: 'AWS rejected the key (InvalidClientTokenId). Check the key and Region in SES credentials.',
    identityErrorAccessDenied: 'The AWS key cannot check the identity (AccessDenied). Update its AWS permissions, then re-check.',
    identityErrorSignatureDoesNotMatch: 'The AWS request signature is invalid (SignatureDoesNotMatch). Check the secret key and Region in SES credentials.',
    identityErrorThrottling: 'AWS temporarily limited the requests (Throttling). Wait a moment, then re-check.',
    identityErrorUnknown: 'The AWS identity check failed. Check the credentials and Region, then re-check.',
    skipReasons: {
      suppressed: 'Suppressed',
    ...
    suppressionReasons: {
      ...
      unsubscribe_global: 'Global unsubscribe',
      erasure: 'Account erasure',
    },
    bounceClassifications: {
      soft: 'Soft bounce',
      hard: 'Hard bounce',
      unresolved: 'Unresolved bounce',
      complaint: 'Spam complaint',
    },
  },
};

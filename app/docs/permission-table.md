...
| api-key | `apps/server/src/internal-app.ts:170` | `authenticateApiKey,` |
...
| staff-role | `apps/server/src/internal-app.ts:1536` | `(identity.staffRole \|\| identity.memberId)` |
| member-scope | `apps/server/src/internal-app.ts:1536` | `(identity.staffRole \|\| identity.memberId)` |

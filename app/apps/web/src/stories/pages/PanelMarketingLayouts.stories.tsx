...
const meta = { title: 'Pages/PanelMarketingLayouts', id: 'panel-marketing-layouts', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'en', layout: 'fullscreen' } } satisfies Meta;
export default meta;

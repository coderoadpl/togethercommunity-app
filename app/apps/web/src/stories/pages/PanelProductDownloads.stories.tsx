...
const meta = { title: 'Pages/PanelProductDownloads', id: 'panel-product-downloads', render: () => <></>, decorators: [withPage], parameters: { fixture, locale: 'pl', layout: 'fullscreen' } } satisfies Meta;
export default meta;
